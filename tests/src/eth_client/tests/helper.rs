use crate::eth_client::types::{
    generated::{basic,basic::{BytesVec, Byte32}, witness, dags_merkle_roots, double_node_with_merkle_proof}
};
use crate::*;
...
pub fn run_test_case(case: TestCase) {
    ...
    let header_input: BlockHeader = rlp::decode(hex::decode("").expect("").as_slice()).unwrap();
    let user_lockscript =
        basic::Script::from_slice(case.cell_data.user_lockscript.as_slice()).unwrap();
    let header_info_input = basic::HeaderInfo::new_builder().header(basic::Bytes::from(hex::decode("").expect("")))
    ...
    let input_data = CellData::new_builder()
        ...
        .build();
    let header_output: BlockHeader = rlp::decode(hex::decode("").expect("").as_slice()).unwrap();
    let header_info_output = basic::HeaderInfo::new_builder().header(basic::Bytes::from(hex::decode("").expect("")))
